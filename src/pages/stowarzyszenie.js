...
const Stowarzyszenie = () => (
  <Layout>
    <article>
      ...
      <p>
        Stowarzyszenie założyła grupa przyjaciół których połączyła wspólna pasja
        – historia miasta i umocnień Wrocławia. Pierwsze plany utworzenia tego
        typu organizacji narodziły się już około roku 2009 natomiast
        Stowarzyszenie powstało w 2012 roku.
      </p>

      <p>
        Naszym celem jest ratowanie przed postępującą dewastacją militarnych
        obiektów na terenie miasta Wrocławia i okolicy a w dalszym okresie czasu
        wyeksponowanie i odnowa tychże obiektów.
      </p>
      ...
      <p>
        ...
        fortyfikacyjnych wzniesionych jeszcze w XIX wieku. Zmodernizowany na
        początku XX wieku posiadał wiele nowoczesnych rozwiązań zarówno
        związanych z architekturą militarną, jak też z systemami łączności. Po
        1945 roku Ludowemu Wojsku Polskiemu, Obronie Cywilnej. Pozbawiony
        regularnych remontów powoli niszczał. Od końca lat osiemdziesiątych stał
        opuszczony popadając w zapomnienie i ruinę. Wrocławskie Stowarzyszenie
        Fortyfikacyjne przy wsparciu wielu oddanych sprawie sympatyków historii,
        militariów i wrocławskich zabytków od roku 2013 opiekuje się obiektem
      ...
      <p>
        ...
        piechoty, tzw. Ślimaka. Spotkaliśmy się już na forcie, by pracować nad
        jego odbudową, ponad 175 razy ! Wszystko co osiągnęliśmy, zostało
